...
export default function VM() {
  ...
  const sendCommand = (command) => {
    ...
    // Track command execution (simplified - actual execution time would need backend feedback)
    setTimeout(() => {
      trackCommand(vmId, command, Date.now() - startTime, true);
    }, 100); // Assume 100ms base execution time for now
  };
